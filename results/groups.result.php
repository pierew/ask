...
for ($i = 0; $i < sizeof($groupResults); $i++) {
    echo $groupResults[$i]['ask_question_idask_question'];
}
echo '<pre>';
...
echo "Ergebnisse f&uuml;r Gruppe: <b>". getGroupName($_GET['gid']) ." <br></b>
...
<canvas id='antworten' width='999' height='30' style='border:1px solid #000000;'></canvas>
      ...
      <script>
        ...
        context.fillText('Antworten fuer Gruppe: ". getGroupName($_GET['gid']). "',350,24);
...
<!--Zeichnet den Hintergrund der oberen Box auf denen sich die oberen Balken befinden-->
  ...
  <canvas id='backgroundRect".$groupResults[$i]['ask_question_idask_question']."' width='1200' height='100' style='border:1px solid #000000;'></canvas>
      <script>
        var canvas = document.getElementById('backgroundRect".$groupResults[$i]['ask_question_idask_question']."');
        var context = canvas.getContext('2d');
      ...
      <script>
        ...
        context.fillStyle='#000000';
        context.fillText('Frage Nr. " . $groupResults[$i]['ask_question_idask_question'] . "',1015,62);
      ...
      <script>
        ...
        //Zeichnet das X
        context.beginPath();
        context.moveTo(". $groupResults[$i]['ask_question_idask_question'] ."*100-100, 0);
        context.lineTo(". $groupResults[$i]['ask_question_idask_question'] ."*100, 100);
        context.lineWidth = 4;
      ...
      <script>
        ...
        //Zeichnet das X
        context.beginPath();
        context.moveTo(". $groupResults[$i]['ask_question_idask_question'] ."*100-100, 100);
        context.lineTo(". $groupResults[$i]['ask_question_idask_question'] ."*100, 0);
        context.lineWidth = 4;
